...
/**
 * PrintNumOfAppearances gets a hyponym and a database and prints the hyponym's hypernyms and the number
 * of Appearances in each of them.
 * @author Yossi Maatook.
 */
public class PrintNumOfAppearances {
     ...
     * @param database - the database of the hypernyms and hyponym's.
     */
